...
Data Cake is an NLP-driven generator that learns distributions and rare-event tails from real customer data, then produces synthetic streams matching those properties without preserving any traceable link. XGBoost and scikit-learn for statistical modeling; a deterministic rules engine enforcing tax-law validity. Models trained on Data Cake output performed within 2% of models trained on real data. The unlock wasn't accuracy — it was that ML projects stopped being a regulatory negotiation.

[How Data Cake Got Built](/2025/12/11/how-data-cake-got-built.html)
...
[Doc Intel: What Happens When Your Code and Docs Divorce](/2026/01/28/doc-intel-patent.html)
...
[Why I Built a Self-Balancing Tree to Make Audit Defense Decisions](/2025/10/22/audit-red-black-tree-patent.html)
...
[Mort AI Nexus: Predicting Economic Nexus Before It Bites You](/2026/01/14/mort-ai-nexus-patent.html)
...
[Robby: I Built an AI System to Kill the Super Chicken Problem](/2026/02/19/robby-ai-sdlc-system.html)
